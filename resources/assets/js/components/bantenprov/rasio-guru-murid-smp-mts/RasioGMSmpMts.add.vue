...
miniToastr.init();
export default {
    name: "rasio-guru-murid-smp-mts_add",
    components: {
        Datepicker
    },
    data() {
        return {
            rasio-guru-murid-smp-mtss: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rasio-guru-murid-smp-mts/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rasio-guru-murid-smp-mts/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rasio-guru-murid-smp-mts/create'
                  }
                },
                window.location.href = '#/admin/rasio-guru-murid-smp-mts/create')
        ...
        back() {
            window.location = '#/admin/rasio-guru-murid-smp-mts';
        }
    },
    mounted: function() {
        axios.get("/rasio-guru-murid-smp-mts/create").then(response => {
